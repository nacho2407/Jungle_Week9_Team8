#include "Render/Hardware/State/DepthStencilStateManager.h"
...
void FDepthStencilStateManager::Set(ID3D11DeviceContext* InContext, EDepthStencilState InState)
{
    ...
    case EDepthStencilState::Default:
        InContext->OMSetDepthStencilState(Default, 0);
        break;
    case EDepthStencilState::DepthReadOnly:
        InContext->OMSetDepthStencilState(DepthReadOnly, 0);
        break;
    case EDepthStencilState::StencilWrite:
        InContext->OMSetDepthStencilState(StencilWrite, 1);
        break;
    case EDepthStencilState::StencilWriteOnlyEqual:
        InContext->OMSetDepthStencilState(StencilMaskEqual, 1);
        break;
    case EDepthStencilState::NoDepth:
        InContext->OMSetDepthStencilState(NoDepth, 0);
        break;
    case EDepthStencilState::GizmoInside:
        InContext->OMSetDepthStencilState(GizmoInside, 1);
        break;
    case EDepthStencilState::GizmoOutside:
        InContext->OMSetDepthStencilState(GizmoOutside, 1);
        break;
    }
