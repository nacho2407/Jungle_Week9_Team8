...
private:
    ...
    void CollectAllProxies(TArray<FPrimitiveProxy*>& OutProxies) const;
    ...
    void QueryFrustumProxiesInternal(const FConvexVolume& ConvexVolume, TArray<FPrimitiveProxy*>& OutProxies, bool bParentContained) const;
